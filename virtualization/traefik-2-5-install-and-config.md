...
介于网上traefik 2.X版本安装配置文档杂乱，参考了官方文档和踩坑后记录如下

kubernetes的安装配置 <https://bbotte.github.io/virtualization/kubernetes-cluster-1-22-install>
...
接下来就要部署traefik，参考 https://doc.traefik.io/traefik/user-guides/crd-acme/#deployments
...
spec:
  entryPoints:
    - web
  routes:
  - match: Host(`traefik.bbotte.github.io`)
    kind: Rule
    services:
      - name: traefik
        port: 8080
