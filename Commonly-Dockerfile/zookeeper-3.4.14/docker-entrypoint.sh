...
function create_config() {
    ...
    echo "admin.serverPort=8111" >> $ZK_CONFIG_FILE
    echo "4lw.commands.whitelist=stat, ruok, conf, isro" >> $ZK_CONFIG_FILE
    for server in $ZOO_SERVERS;do echo "$server" >> $ZK_CONFIG_FILE ;done
